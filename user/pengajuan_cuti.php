<div role="main">
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($atasan == 'panitera') {
              ...
              $query = mysqli_query($koneksi, "INSERT INTO cuti_pegawai VALUES (null, '$id', '$jenis', '$alasan', '$lama', '$ketlama', '$dari', '$sampai' ,null, $panitera, null, 1, 0, 0, 'Diajukan', 'Menunggu Approval Panitera')");
